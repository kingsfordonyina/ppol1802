...
# **1. Theoretical Model**
This model examines the relationship between partisanship (`p_afil`) and support for Ghana's Free Senior High School (FSHS) (`index_bin`). It includes confounders, mediators, and potential colliders.
